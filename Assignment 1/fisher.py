...
class Fischer:
    ...
    def transform_data(self):
        ...
        b = -2*(((self.class_values[0]['std']**2)*self.class_values[1]['mean'])-(
            (self.class_values[1]['std']**2)*self.class_values[0]['mean']))
        c = ((self.class_values[0]['std']**2)*(self.class_values[1]['mean']**2))-((self.class_values[1]['std']**2)*(self.class_values[0]['mean']**2))-2*(
            (self.class_values[0]['std']*self.class_values[1]['std'])**2)*(np.log((self.class_values[0]['std'])/(self.class_values[1]['std'])))
        dis = (b**2)-(4*a*c)
        dis = dis**(1/2)
        x1 = ((-b)+dis)/(2*a)
        x2 = ((-b)-dis)/(2*a)
    ...
    def test_algorithm(self):
        ...
        self.f_score = float(2*self.precision*self.recall) / \
